...
@Component
public class HelpChatHandler implements CommandChatHandler {

    private static final Set<String> COMMANDS = Set.of("h", "help");
    ...
    public Optional<String> handle(ChatChannel chatChannel, ChatRequest request) {
        ...
        return Optional.of(templateService.render("command/help", Map.of(
                "request", request
        )));
    }
