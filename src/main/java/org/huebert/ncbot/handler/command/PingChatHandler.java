...
@Component
public class PingChatHandler implements CommandChatHandler {

    private static final Set<String> COMMANDS = Set.of("p", "ping");
    ...
    public Optional<String> handle(ChatChannel chatChannel, ChatRequest request) {
        ...
        return Optional.of(templateService.render("command/ping", Map.of(
                "request", request
        )));
    }
